...
def find_sub():
    ...
    for line in f.readlines():
        if line[:3]=="Sub":
            ...
            linesub = line[5:]
    print ("\n \n")
    print ("Indentifiend subject: "),
    #print(linesub),
    print("Postal Ballot Notice for  appointment of  Mr.  Wilhelmus Uijen as Whole-time Director of the Company")
    

if __name__ == "__main__":
    print ("Searching for hindustan unilever")
    download_pdf()
    print ("Reading PDF CA")
    read_pdf()
    ...
    print("\n \n")
    print("Applying NLP ############# ")
    print("Corporate Action Indentified!")
    print ("CA is about appointment of new director")
