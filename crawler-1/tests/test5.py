...
init_web_list = [
    ...
    # ["economictimes2", "https://economictimes.indiatimes.com/markets/stocks/news","10"],
    ...
    ["bing1", "https://www.bing.com/search?q=news+agm", "4"],
    ["bing2", "https://www.bing.com/search?q=news+Acquisition", "4"],
    ["bing3", "https://www.bing.com/search?q=news+AGM+EGM", "4"],
    ["bing4", "https://www.bing.com/search?q=news+Assimilation", "4"],
    ["bing5", "https://www.bing.com/search?q=news+Bankruptcy", "4"],
    ["bing6", "https://www.bing.com/search?q=news+Bonus+Issue", "4"],
    ["bing7", "https://www.bing.com/search?q=news+Bonus+Rights", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Buy-back+program+BIDS+Repurchase+Offer", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Cash+Dividend", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Class+Action", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Delisting", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Demerger", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Dividend+Reinvestment+Plan+DRIP", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Dutch+Auction", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Early+Redemption", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Final+Redemption", "4"],
    ["bing8", "https://www.bing.com/search?q=news+General+Announcement", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Initial+Public+Offering+IPO", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Liquidation", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Mandatory+Exchange++Conversion", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Merger", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Optional+Dividend", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Reverse+Stock+Split", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Spin+Off", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Scrip+Issue", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Takeover", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Tender+Offer", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Warrant+Exercise", "4"],
    ["bing8", "https://www.bing.com/search?q=news+Warrant+Expiry", "4"],
...
if __name__ == "__main__":
    ...
    update_webs = input("Do you want to update the webs table? y/Y : ")
    if update_webs == 'y' or update_webs == 'Y':
